...
from coding_tools.MLIC.MLICPP.utils.training import train_one_epoch, train_one_epoch_ddp
...
def main():
    ...
    lr_scheduler = optim.lr_scheduler.MultiStepLR(
        optimizer, milestones=[80, 100], gamma=0.1
    )
    ...
    if args.checkpoint != None:
        ...
        lr_scheduler = optim.lr_scheduler.MultiStepLR(
            optimizer, milestones=[450, 550], gamma=0.1
        )
