...
color0, color1, color2, color3, colorp = (
    "#211A3E",
    "#453370",
    "#A597B6",
    "#FEF3E8",
...
cm = LinearSegmentedColormap.from_list(
    name="KeQing", colors=list(zip(positions, [color0, color1, color2, color3])), N=256
)
...
for w_time in D.keys():
    ax.plot(
        R[w_time], D[w_time], label=f"$\\alpha={w_time[7:]}$", marker=".", linewidth=0.7
    )
