...
# python tools/tester.py "$BASEDIR/mosaic" -i "$DATASET_DIR" --tools EVC TCM --tool_filter EVC_LS TCM_VBR2_2 -N 1000 --num-gen 1000 --w_time 0.029 --save_image --bpg_qp 32 --mosaic
