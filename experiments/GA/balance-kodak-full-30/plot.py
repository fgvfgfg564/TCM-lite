...
ax.plot(T, D, label="Ours", marker='o', color='blue')
...
plt.tight_layout()
plt.savefig(os.path.join(basedir, "kodak-balance.png"), dpi=300)
plt.savefig(os.path.join(basedir, "kodak-balance.pdf"))