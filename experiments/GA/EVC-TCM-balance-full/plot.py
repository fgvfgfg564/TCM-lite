...
def plot(image_name):
    folder = os.path.join(ROOTDIR, image_name)
    out_folder = os.path.join(ROOTDIR, 'plots')
    os.makedirs(out_folder, exist_ok=True)
    img_rawname = os.path.splitext(image_name)[0]
    ...
    ax.set_xlim(0.)
    plt.tight_layout()
    plt.savefig(os.path.join(out_folder, img_rawname + "-d-t.png"), dpi=300)
    plt.savefig(os.path.join(out_folder, img_rawname + "-d-t.pdf"))
    plt.close()
    ...
    # ax.set_title("DOG_4507.png")
    plt.tight_layout()
    plt.savefig(os.path.join(out_folder, img_rawname + "-r-d.png"), dpi=300)
    plt.savefig(os.path.join(out_folder, img_rawname + "-r-d.pdf"))
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(out_folder, img_rawname + "-3d.png"), dpi=300)
    plt.savefig(os.path.join(out_folder, img_rawname + "-3d.pdf"))
    plt.close()
