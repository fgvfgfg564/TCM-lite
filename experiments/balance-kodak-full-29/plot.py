...
ax.plot(T[:-1], D[:-1], label="Ours", marker='o', color='blue')
...
plt.tight_layout()
plt.savefig(os.path.join(basedir, "kodak-balance-qp29.png"), dpi=300)
plt.savefig(os.path.join(basedir, "kodak-balance-qp29.pdf"))